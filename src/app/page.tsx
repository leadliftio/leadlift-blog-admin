    ...
    <div>
      <div className="bg-white">
        <div className="max-w-[1200px] mx-auto lg:py-[100px] py-[50px] px-[20px] lg:px-0">
          ...
          >
            <div className="absolute w-full h-full top-0 left-0 bg-[rgba(0,0,0,0.5)] rounded-[20px] md:rounded-[40px]" />
            <div className="relative">
              ...
              <p className="lg:w-[500px] w-full text-white font-semibold font-poppins text-[28px] lg:text-[60px] leading-[120%] lg:tracking-[3px] lg:mb-[24px] ">
                {/* Landing your first job as a Data analyst: My career switch */}
                {posts[0]?.title}
              </p>
              <div className="flex gap-[12px]">
                <Link
                  className="text-white font-outfit text-base font-medium leading-[120%] lg:tracking-[-0.32px] flex items-center gap-[4px] bg-[#50CE78] rounded-[8px] p-[16px] w-fit"
